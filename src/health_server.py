...
table{width:100%;border-collapse:collapse}td,th{text-align:left;padding:8px 10px;border-bottom:1px solid #1f2937}.meet-mini{display:flex;align-items:center;gap:6px;margin-bottom:5px;color:#94a3b8;font-size:12px;line-height:1.25}.meet-mini-code{overflow-wrap:anywhere}.mini-icon{width:22px;height:22px;padding:0;display:inline-flex;align-items:center;justify-content:center;background:transparent;border:1px solid transparent;border-radius:6px;color:#94a3b8;text-decoration:none}.mini-icon:hover{background:#1e293b;border-color:#334155}.mini-icon svg{width:13px;height:13px}.login{min-height:100vh;display:grid;place-items:center;background:#070b12}.login-box{width:min(360px,calc(100vw - 32px));background:#0f172a;border:1px solid #263244;border-radius:8px;padding:20px;display:flex;flex-direction:column;gap:10px}.login-box input{height:36px;border:1px solid #334155;background:#070b12;color:#e5e7eb;border-radius:6px;padding:0 10px}.error{color:#fca5a5;margin:0}audio{width:min(560px,100%);height:34px;filter:invert(1) hue-rotate(180deg)}
