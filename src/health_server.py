...
function meetMini(code){if(!code)return `<div class="meet-mini">${badge('upcoming')}</div>`; return `<div class="meet-mini">${badge('upcoming')}<button class="mini-copy" onclick="copyText('${esc(code)}',this)" title="Copy meet ID"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg></button></div>`;}
